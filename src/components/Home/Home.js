            ...
            <div className='home-component'>
                {
                    ...
                    <main className='home-grid'>
                        <TopHeadline description={articles[0].description} imgURL={articles[0].urlToImage} title={articles[0].title} objName={'utahNewsObj'} author={articles[0].author} publishedAt={articles[0].publishedAt}/>
                        <div className='home-secondary-headers'>
                            ...
                            <SecondaryHeadline className='middle-secondary-article' imgURL={articles[2].urlToImage} title={articles[2].title} objName={'utahNewsObj'} author={articles[2].author} publishedAt={articles[2].publishedAt}/>
                            <SecondaryHeadline imgURL={articles[3].urlToImage} title={articles[3].title} objName={'utahNewsObj'} author={articles[3].author} publishedAt={articles[3].publishedAt}/>
                        </div>
